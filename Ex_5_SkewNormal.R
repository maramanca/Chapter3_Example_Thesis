...
# Data
y_1 <- read.csv("dati_SN_part_7g.csv", sep="|")
# y_1 <- read.csv("hsa_miR_4855p.csv", sep="|")
# y_1 <- read.csv("hsa_miR_4553p.csv", sep="|")
# y_1 <- read.csv("hsa_miR_24.csv", sep="|")
y_1 <- y_1$expression[y_1$cat == "long"]
...
# Data
y_2 <- read.csv("dati_SN_part_7g.csv", sep="|")
# y_2 <- read.csv("hsa_miR_4855p.csv", sep="|")
# y_2 <- read.csv("hsa_miR_4553p.csv", sep="|")
# y_2 <- read.csv("hsa_miR_24.csv", sep="|")
y_2 <- y_2$expression[y_2$cat == "short"]
